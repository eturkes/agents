...
- The build pins `prefers-color-scheme` to light and drops CDP media emulation → `--dark` promotes the page's own dark media blocks to `all`; cross-origin stylesheets stay light + are reported.
