...
- CachyOS (Arch) workstation; all Codex sessions run as the sole user `eturkes`, with passwordless sudo, full r/w, and network; `$HOME` = `/home/eturkes`.
