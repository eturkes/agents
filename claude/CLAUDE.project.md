...
- Context topology: every context (main session + `Agent`) auto-compacts at 240K, warning at 220K. Aim ~200K, reserving ~40K for verification + closure. MILESTONE-REVIEW is exempt and may continue across compactions. Prune redundant/obsolete information + structures throughout.
