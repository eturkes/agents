...
- `.agent/` attached state (`roadmap.md`, `memory.md`, `polish.md`) enters each session whole, ahead of the first tool call → hold the attached set ≤~75 KB (~24K tokens ≈ 10% of the window); closed-milestone detail moves to an archive path outside that set, read on demand.
