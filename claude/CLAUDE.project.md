...
- Attached state (`.agent/roadmap.md`, `memory.md`, `polish.md`) ≤~24K tokens (~75 KB) total; closed-milestone detail moves to an archive path outside the set, read on demand.
