...
- Attached state (`.agent/roadmap.md`, `memory.md`, `polish.md`) rides every session whole → keep it minimal; closed-milestone detail moves to an archive path outside the set, read on demand.
