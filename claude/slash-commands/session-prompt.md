...
Load `.agent/roadmap.md` (ledger + active detail), then `.agent/memory.md` (lessons + decisions); `CLAUDE.md` auto-injects. Read step-implicated files. Navigate via tokensave/LSP where available, else grep.
