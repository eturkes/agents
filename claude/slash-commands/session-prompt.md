...
- Break the milestone into units that project to fit one Agent context bounded at 240K → aim ~200K, reserve ~40K for variance, verification + closure. Sequence gate-independent prep first; mark a gated unit BLOCKED until its precondition is met.
