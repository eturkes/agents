...
Execute the supplied task exactly with full project context. State arrives attached: @.agent/roadmap.md @.agent/memory.md; an unexpanded path signals absent state. Roadmap MODE dispatch remains `/session-roadmap`-owned; this session's scope = supplied task.
