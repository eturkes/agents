...
Prompt: focus below non-empty ⇒ review exactly that; empty ⇒ adversarially review this session's work — correctness + logic, soundness of the core claims, and any gap between what the code/outputs actually guarantee and what the session claims. Weigh honesty + overreach above style.
